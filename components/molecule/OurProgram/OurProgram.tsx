...
export default class OurProgram extends React.Component<any, any> {
    ...
    programs = [
        {
            ...
            description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since Lorem '
        },
        {
            year: null,
            quarter: 3,
    ...
    render() {
        return (
            <div className={"py-10 bg-real-purple-superdark"}>
