...
const Minicard =() => {
    return(
        <div className="flex flex-col md:flex-row items-center m-auto px-6">

            <div className="shadow-halo px-4 py-6 m-4 md:mr-4 md:my-4 flex flex-row bg-darkBlue w-2/3 md:w-1/3 color-white text-white rounded-xl justify-around ">
            ...
            <div className="shadow-halo px-4 py-6 m-4 flex flex-row bg-darkBlue w-2/3 md:w-1/3 color-white text-white rounded-xl  justify-around ">
