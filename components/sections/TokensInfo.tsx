            ...
            <LayoutBorder>
                ...
                <div className=" flex flex-col items-center space-y-10 lg:space-y-0 space-x-0 lg:space-x-20 lg:flex-row">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className={" text-2xl sm:text-3xl md:text-4xl md:text-4xl p-2 font-semibold tracking-wide text-transparent bg-clip-text bg-gradient-to-br from-yellow to-orange"}>XDAHU</div>
                        <div
